...
func TestCreateMovieUnit(t *testing.T) {
	...
	newMovie := &data.Movie{Title: "Inception", Year: 2010}
...
func TestGetMovieByIDUnit(t *testing.T) {
	mockStorage := &data.MockMovieStorage{
...
func TestUpdateMovieUnit(t *testing.T) {
	mockStorage := &data.MockMovieStorage{
...
func TestDeleteMovieUnit(t *testing.T) {
	...
	err = app.storage.Movies.Delete(42) // Test with a non-existent movie ID
	assert.NotNil(t, err, "Deleting a non-existent movie should result in an error")
}

func TestListMoviesUnit(t *testing.T) {
	mockStorage := &data.MockMovieStorage{
